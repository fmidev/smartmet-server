...
BuildRequires: smartmet-library-spine-devel >= 25.8.20
...
Requires: smartmet-library-spine >= 25.8.20
Provides: smartmetd
...
if getent passwd %{smartmetd_user} >/dev/null; then
    ...
    smartmetd_group=%{smartmetd_user}
...
- Update out of memery handler to get more disgnostic information
